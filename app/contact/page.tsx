export default function contactPage () {
    return (
        <section>
            <h2 className="ml-44 text-xl font-bold text-gray-900 sm:text-3xl">
            Contactanos
        </h2>
          ...
          <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            <div className="lg:col-span-2 lg:py-12">
              <p className="max-w-xl text-lg">
               Tenemos la mejor calidad en productos, podes dejarnos un comentario
              </p>
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
              <form action="" className="space-y-4">
                <div>
                  <label className="sr-only" form="name">Name</label>
                  <input
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    <label className="sr-only" form="email">Email</label>
                    <input
                      className="w-full rounded-lg border-gray-200 p-3 text-sm"
                  ...
                  <div>
                    <label className="sr-only" form="phone">Phone</label>
                    <input
                      className="w-full rounded-lg border-gray-200 p-3 text-sm"
                ...
                <div>
                  <label className="sr-only" form="message">Message</label>
